...
ggplot(data = top_users) + 
  ...
  labs(x = "User", y = NULL,
    title = "Total number of #rstudioconf tweets by user",
...
ggplot(most_rt) +
  ...
  labs(x = "User", y = NULL,
    title = "Mean number of #rstudioconf retweets",
    caption = "\nSource: Data collected from Twitter's REST API via rtweet")
```
...
ggplot(most_rt) +
    ...
    theme(axis.text = element_text(size = 12),
          legend.text = element_text(size = 12)) +
  labs(x = "User", y = NULL,
    title = "Mean number of #rstudioconf favorites",
    caption = "\nSource: Data collected from Twitter's REST API via rtweet")
